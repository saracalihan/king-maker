...
public class UIBuilder {
    ...
    public UIBuilder(){
        try {
            ...
            // load templates
            oauthLoginTemplate = loadTemplate("./src/main/java/com/saracalihan/tahakkum/template/oauth.html");
            totpTemplate = loadTemplate("./src/main/java/com/saracalihan/tahakkum/template/totp.html");
            otpTemplate = loadTemplate("./src/main/java/com/saracalihan/tahakkum/template/otp.html");
